	...
	function init(phpParams) {
		...
		$('#tweet').click(function(ev) {
			if(Machine.isPlaying()) {
				...
				window.location.href = "https://twitter.com/share?url=http%3A%2F%2Fmattbradshawdesign.com%2Fprojects%2Fdrumkid%2F%3Fb=" + getParamString() + "&text=" + tweetText + "&related=" + relatedAccount;
			}
		});
		...
		$('#share').click(function(ev) {
			if(Machine.isPlaying()) {
				...
				window.location.href = "https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent("http://mattbradshawdesign.com/projects/drumkid/?b=" + getParamString());
			}
		});
